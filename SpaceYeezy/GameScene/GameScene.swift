...
//  SpaceYeezy
//
//  Created by Mike Nguyen on 9/9/20.
...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        scoreLabel.position = CGPoint(x: 150, y: self.frame.size.height - 80)
    ...
    @objc func addAlien() {
        ...
        // gives aliens actions to move down screen and then disappear when they reach the bottom of the screen
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        ...
        if contact.bodyA.categoryBitMask < contact.bodyB.categoryBitMask {
            firstBody = contact.bodyA // photon
